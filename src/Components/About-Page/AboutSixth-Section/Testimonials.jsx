...
import TestimonialsAnime from "./TestimonialsAnime";
  ...
  return (
    <>
      <section id="reviews" className={styles.testSec}>
        ...
        <div
          ref={testimonialsRef}
          className={`${styles.testimonials} ${styles.flex} ${styles.ac}`}
        >
          {customers.map((reviews, idx) => (
            ...
            >
              <div className={styles.customerInfo}>
                ...
                <div
                  className={`${styles.details} ${styles.flex} ${styles.fClmn}`}
                >
                  <p>{reviews.name}</p>
      ...
      <TestimonialsAnime testimonialsRef={testimonialsRef} />
    </>
  );
};
